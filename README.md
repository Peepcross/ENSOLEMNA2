...
R: Gracias a la comparacion anterior sabemos cuales bacterias han sido reportadas como patógenas y cuales son parte de la microbiota normal. Ahora bien, me enfocaria en el grupo de bacterias patógenas y realizaria diversos cultivos para cada una, segun los parámetros registrados en las bases de datos, y la que produzca y coincida con los síntomas presentes en el paciente, puede ser señalada como el causante patógeno. 
